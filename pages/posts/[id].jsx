        ...
        <article className={styles.articleBody}>
          ...
          <section className={styles.shareSection} aria-label="이 아티클 공유하기">
            ...
            <div className={styles.shareButtons}>
              ...
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12.186 24c-3.564 0-6.398-1.109-8.423-3.296C1.737 18.518.73 15.342.77 11.233c.04-4.04 1.134-7.208 3.253-9.418C6.142-.395 9.043-.637 12.651.697c3.483 1.288 6.009 3.731 7.307 7.068 1.144 2.942 1.096 6.08-.139 9.076-1.579 3.829-4.704 6.059-8.814 6.279l-.819.043zm.252-2.189c3.342-.178 5.768-1.921 7.018-5.042.997-2.489 1.036-5.074.113-7.483-1.047-2.73-3.08-4.717-5.882-5.748-2.92-1.077-5.244-.881-6.907.585-1.745 1.538-2.64 4.095-2.664 7.604-.033 3.428.796 6.068 2.463 7.848 1.637 1.748 3.935 2.236 6.64 2.236h-.781z"/>
                </svg>
                <span>Threads</span>
              </a>
            </div>
